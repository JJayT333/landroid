...
- Current browser coverage checks the refreshed demo loaders, visible Desk Map PDF filename chips, attach/replace lease PDF behavior, same-owner multi-tract lease records, Research opening as the source workspace, and stress-seed document badges.
