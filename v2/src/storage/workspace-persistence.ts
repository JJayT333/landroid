...
export function exportLandroidFile(data: WorkspaceData): Blob {
  const payload = {
    version: 2,
...
export function downloadLandroidFile(data: WorkspaceData) {
...
export async function importLandroidFile(file: File): Promise<WorkspaceData> {
