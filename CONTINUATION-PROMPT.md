...
Vulcan Mesa demo rename, archived ultrareview prompt, and W1 Vulcan Mesa
fixture set. `docs/phase-0-inventory.md` is the draft master Phase 0 inventory
after Claude's lane review. `fixtures/phase-0/` contains deterministic W1
goldens generated by `scripts/generate-phase-0-fixtures.ts`. Backend
