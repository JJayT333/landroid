...
- W2 Raven Forest-scale fixture strategy is documented as
  `fixtures/phase-0/raven-forest-stress-recipe.md`; do not commit today's exact
  large seed as the permanent rebuild fixture unless a later generated artifact
  stays reviewably small.
- Next Phase 0 work: capture performance baselines and mark remaining inventory
  rows as verified or `needs verification`.
...
rebuild stress recipe instead of a committed exact large export. Backend
