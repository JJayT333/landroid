...
| `docs/research/txm-catalog-round-1.md` | External research corpus, round 1: TXM master index (50 items), temporal law ledger, Tier-1 blocks, double-fraction/probate/DOI packs. Reference, not authority — attorney check required before any formula lands. | Rounds 2-3 land beside it; archive the set when reconciled into the math design pass. |
